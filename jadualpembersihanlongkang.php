...
$sql = "SELECT * FROM pembersihan_awam WHERE SubKategori='Pembersihan longkang'";
...
<div class="container-fluid" >
  ...
  <div class="col-sm-12 text-left">
    <h3> Pengurusan Pembersihan Awam (Sub Kategori: Pembersihan Longkang)</h3>
     <a href="tambahdatabersih.php" class="btn  btn-success "><img src="image/databaru.png" width=30 height=30>  Tambah Data Baru</a>
   
         <a href="cetakpembersihanlongkang.php" class="btn btn-info"><img src="image/printer.png" width=30 height=30> Cetak </a>
           <a href="cari.php" class="btn btn-warning"><img src="image/search.png"  width=30 height=30> Carian Data</a>
            <a href="cari.php" class="btn btn-primary" class="btn pull-left btn-primary dropdown-toggle "  type="button"  data-toggle="dropdown"><img src="image/kategori.png" width=30 height=30> SubKategori <span class="caret"></span></a>
                  ...
                  <tr>
                        ...
                        <?php while($row = mysqli_fetch_assoc($result)){ ?>
                                ...
                                <td> 
                                  ...
                                  <a href="editpembersihanlongkang.php?IDPembersihan=<?php echo $row['IDPembersihan']; ?>" class="btn btn-info" >
