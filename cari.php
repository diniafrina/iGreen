                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="SubKategori" class="form-control" id="SubKategori" placeholder="SIla Pilih SubKategori">
                                                    <option>Sila Pilih Jenis SubKategori</option>
                                                     <option>Pembersihan Jalan</option>
                                                    <option>Pembersihan Longkang</option>
                                                    <option>Pemotongan Rumput</option>
                                            ...
                                            <div>
                                                <input  class="btn btn-info" type="submit" name="cari" value="CARI">
                                                 <input class="btn btn-success" type="button" value="CETAK" id="btnPrint" />
                                                   <a href="pembersihan_awam.php"> <input  class="btn btn-danger" type="button" name="kembali" value="KEMBALI"></a>
                                            </div>
                                            <br>
                                            </div>
...
//                                            $category = mysql_real_escape_string(stripslashes($_POST['category'])); 
                                            ...
                                            $sql = "SELECT * FROM pembersihan_awam WHERE NamaTaman='$NamaTaman' AND SubKategori='$SubKategori' ";
                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <td><center>SubKategori</center></td>
                                                <td><center>Jenis SubKategori</center></td>
                                                <td><center>Unit<br>Panjang<br>Keluasan</center></td>
                                                <td><center>Jenis</center></td>

                                                <td><center>Frekuensi</center></td>
                                                <td><center>Nama Jalan</center></td>
                                                <td><center>Nama Taman</center></td>
                                                <td><center>Catatan</center></th>
                                                </td>
                                                    </tr>
                                                    ...
                                                    <?php while ($result2 = mysqli_fetch_assoc($result_apply)) { ?>
                                                        ...
                                                        <td><center><?php echo $result2['JenisSubKategori']; ?></center></td>
                                                        <td><center><?php echo $result2['UnitPanjangKeluasan']; ?> </center></td>
                                                        <td><center><?php echo $result2['Jenis']; ?></center></td>
