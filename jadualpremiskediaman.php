...
$sql = "SELECT * FROM sisa_pepejal WHERE SubKategori='Premis Kediaman'";
...
<div class="container-fluid" >
  ...
  <div class="col-sm-12 text-left">
    <h3> Pengurusan Sisa Pepejal: Premis Kediaman</h3>
     <a href="tambahdata.php" class="btn  btn-success "><img src="image/databaru.png" width=30 height=30>  Tambah Data Baru</a>
   
         <a href="printpremiskediaman.php" class="btn btn-info"><img src="image/printer.png" width=30 height=30> Cetak </a>
                        ...
                        <?php $num=1;
                            ...
                            while($row = mysqli_fetch_assoc($result)){ ?>
                                ...
                                <td> 
                                  ...
                                  <a href="editpremiskediaman.php?IDPepejal=<?php echo $row['IDPepejal']; ?>" class="btn btn-info" >
                                     <span title="Kemaskini" class="glyphicon glyphicon-pencil"></span> 
                                 </a>

<br>
                                  <a href="padamdatapremiskediaman.php?IDPepejal=<?php echo $row['IDPepejal']; ?>" class="confirmation btn btn-danger" 
