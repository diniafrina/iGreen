...
$sql = "SELECT * FROM pembersihan_awam WHERE SubKategori='Pemotongan Rumput'";
...
<div class="container-fluid" >
  ...
  <div class="col-sm-12 text-left">
    <h3> Pengurusan Pembersihan Awam (Sub Kategori: Pemotongan Rumput)</h3>
     <a href="tambahdatabersih.php" class="btn  btn-success "><img src="image/databaru.png" width=30 height=30>  Tambah Data Baru</a>
   
         <a href="cetakpemotonganrumput.php" class="btn btn-info"><img src="image/printer.png" width=30 height=30> Cetak </a>
                  ...
                  <tr>
                        ...
                        <?php while($row = mysqli_fetch_assoc($result)){ ?>
                                ...
                                <td> 
                                  ...
                                  <a href="editpemotonganrumput.php?IDPembersihan=<?php echo $row['IDPembersihan']; ?>" class="btn btn-info" >
